...
assert(isnan(Mapped.FeedbackTargetRadiusPx), ...
    'debug_value should not assign FeedbackTargetRadiusPx.');
assert(isnan(Mapped.FeedbackDisplayRadiusPx), ...
    'debug_value should not assign FeedbackDisplayRadiusPx.');
assert(isnan(Mapped.FeedbackOuterRadiusPx), ...
    'debug_value should not assign FeedbackOuterRadiusPx.');
assert(strcmp(Mapped.FeedbackDisplayType, ''), ...
    'debug_value should not assign FeedbackDisplayType.');
...
assert(isnan(MappedNone.FeedbackTargetRadiusPx), ...
    'none mode should leave FeedbackTargetRadiusPx at default.');
assert(isnan(MappedNone.FeedbackDisplayRadiusPx), ...
    'none mode should leave FeedbackDisplayRadiusPx at default.');
assert(isnan(MappedNone.FeedbackOuterRadiusPx), ...
    'none mode should leave FeedbackOuterRadiusPx at default.');
assert(strcmp(MappedNone.FeedbackDisplayType, ''), ...
    'none mode should leave FeedbackDisplayType at default.');
