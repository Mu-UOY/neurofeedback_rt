function test_step3d_trial_cleanup_on_rt_error()
% TEST_STEP3D_TRIAL_CLEANUP_ON_RT_ERROR Check trial cleanup on RT error.
...
assert(strcmp(TrialResult.ErrorIdentifier, 'test:rt_error'), ...
